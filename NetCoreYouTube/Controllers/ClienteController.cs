...
namespace NetCoreYouTube.Controllers
{
    ...
    public class ClienteController : ControllerBase
    {
        ...
        public dynamic guardarCliente(Cliente cliente)
        {
            ...
            return new { success = true, message = "cliente registrado", result = cliente };
        }
        ...
        public dynamic eliminarCliente(Cliente cliente)
        {
            ...
            if(usuario.rol != "administrador")
            {
                ...
                {
                    success = false,
                    message = "No tienes permiso para borrar esta api",
                    result = ""
                };
            }

            return new { success = true, message = "cliente eliminado", result = cliente };
        }
    }
}
